...
class FertilizanteDAO {
    ...
    public function Save(FertilizanteDTO $obj) {
        $query = $this->repository->buildQuerySimply("savefertilizante", array((int) $obj->getId(),
            (int) $obj->getnumero(),
            (float) $obj->getarea(),
    ...
    public function Update(FertilizanteDTO $obj) {
        $query = $this->repository->buildQuerySimply("updatefertilizante", array((int) $obj->getId(),
            (int) $obj->getnumero(),
            (float) $obj->getarea(),
            (string) $obj->getobservacion(),
            (int) $obj->getidrotacion(),
