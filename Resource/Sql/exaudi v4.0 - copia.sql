...
CREATE DEFINER=`exaudio1`@`localhost` FUNCTION `savenoticia`(`cod` INT, `titl` VARCHAR(200), `des` VARCHAR(10000), `fech` VARCHAR(20), `phot` VARCHAR(2000), `vid` VARCHAR(500)) RETURNS int(1)
    READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`exaudio1`@`localhost` FUNCTION `updatenoticia`(`cod` INT, `titl` VARCHAR(200), `des` VARCHAR(10000), `fech` VARCHAR(20), `phot` VARCHAR(2000), `vid` VARCHAR(500)) RETURNS int(1)
    READS SQL DATA
    DETERMINISTIC
